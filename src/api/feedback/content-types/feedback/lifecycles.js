    ...
    async afterCreate(event) {
        ...
        try {
            await strapi.plugins['email'].services.email.send({
                ...
                subject: `Обратная связь от ${result.name}`,
                                                                        ...
                                                                        >
                                                                            <p style="margin: 0; font-size: 14px; text-align: center;">
                                                                                <span style="font-size: 46px;">
                                                                                    <strong><span style="font-size: 38px;">Здравствуйте,</span> <span style="font-size: 38px; color: #ffc006;">${data.name}</span></strong>
                                                                                </span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div style="font-family: Tahoma, sans-serif;">
                                                                        ...
                                                                        >
                                                                            <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 24px;">
                                                                                <span style="font-size: 16px;">Мы получили Ваше сообщение.</span>
                                                                            </p>
                                                                            <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 24px;">
                                                                                <span style="font-size: 16px;">Выйдем с Вами на связь в ближайшее время!</span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td style="padding-bottom: 5px; padding-left: 10px; padding-right: 10px; padding-top: 10px;">
                                                                    <div style="font-family: Tahoma, sans-serif;">
                                                                        ...
                                                                        >
                                                                            <p style="margin: 0; font-size: 14px; text-align: center;">
                                                                                <span style="font-size: 46px;">
                                                                                    <strong><span style="font-size: 38px;">Новое сообщение от</span> <span style="font-size: 38px; color: #ffc006;">${data.name}</span></strong>
                                                                                </span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <td style="padding-bottom: 10px; padding-left: 20px; padding-right: 20px; padding-top: 10px;">
                                                                    <div style="font-family: sans-serif;">
                                                                        ...
                                                                        >
                                                                            <p style="margin: 0; font-size: 14px;">Информация о клиенте</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <ul
                                                                        ...
                                                                        "
                                                                    >
                                                                        <li style="margin-bottom: 7px;">Имя заказчика: ${data.name}</li>
                                                                        <li style="margin-bottom: 7px;">Email: ${data.email}</li>
                                                                        <li style="margin-bottom: 7px;">Телефон: ${data.phone}</li>
                                                                    </ul>
                                                                    <p>${data.message}</p>
                                                                </td>
                                                            </tr>
