                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <li style="margin-bottom: 7px;">Дата доставки: ${data.details.date}</li>
                                                                        <li style="margin-bottom: 7px;">Время доставки: с ${data.details.workTime.minTime} до ${data.details.workTime.maxTime}</li>
                                                                ...
                                                                <td style="padding-bottom: 5px; padding-left: 10px; padding-right: 10px; padding-top: 10px;">
                                                                    <div style="font-family: Tahoma, sans-serif;">
                                                                        ...
                                                                        >
                                                                            <p style="margin: 0; font-size: 14px; text-align: center;">
                                                                                <span style="font-size: 46px;">
                                                                                    <strong><span style="font-size: 38px;">Новый заказ от</span> <span style="font-size: 38px; color: #ffc006;">${data.name}</span></strong>
                                                                                </span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
